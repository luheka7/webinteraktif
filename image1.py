...
def buat_filter(gambar, jenis_filter):
    if jenis_filter == "BLUR":
        gambar_filter = gambar.filter(ImageFilter.BLUR)
    elif jenis_filter == "CONTOUR":
        gambar_filter = gambar.filter(ImageFilter.CONTOUR)
    elif jenis_filter == "EMBOSS":
        gambar_filter = gambar.filter(ImageFilter.EMBOSS)
    elif jenis_filter == "SHARPEN":
        gambar_filter = gambar.filter(ImageFilter.SHARPEN)
    else:
        gambar_filter = gambar.filter(ImageFilter.SMOOTH)
